...
const schema = Joi.object({
  departmentName: Joi.string().min(6).max(30).required().messages({
  ...
  departmentManager: Joi.string().min(3).max(30).optional().message({
  ...
  departmentDescription: Joi.string().min(6).max(200).optional().messages({
